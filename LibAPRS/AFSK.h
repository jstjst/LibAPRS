...
#define LED_TX_INIT() do { LED_DDR |= _BV(LED_TX_PIN); } while (0)
#define LED_TX_ON()   do { LED_PORT |= _BV(LED_TX_PIN); } while (0)
#define LED_TX_OFF()  do { LED_PORT &= ~_BV(LED_TX_PIN); } while (0)

#define LED_RX_INIT() do { LED_DDR |= _BV(LED_RX_PIN); } while (0)
#define LED_RX_ON()   do { LED_PORT |= _BV(LED_RX_PIN); } while (0)
#define LED_RX_OFF()  do { LED_PORT &= ~_BV(LED_RX_PIN); } while (0)
